...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Bitcoin Finance(BTF) address (e.g. %1)").arg(
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("btf://", Qt::CaseInsensitive))
    {
        uri.replace(0, 10, "btf:");
    }
...
{
    QString ret = QString("btf:%1").arg(info.address);
    int paramCount = 0;
