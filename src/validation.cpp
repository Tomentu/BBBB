...
const std::string strMessageMagic = "BitcoinFinance(BTF) Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck = false)
{
    ...
    bool fEnforceBIP30 = (!pindex->phashBlock) || // Enforce on CreateNewBlock invocations which don't have a hash.
                          !((pindex->nHeight==91842 && pindex->GetBlockHash() == uint256S("00000000a9310018dd6b31d59c47b8ec92dc7c2efa4fb3a70600584ab7106497")) ||
                           (pindex->nHeight==91880 && pindex->GetBlockHash() == uint256S("00000000abbc297c10907d67786ecb6f48899d553fdb171228f82fa4dac98b0a")));
    
    //00000000a9310018dd6b31d59c47b8ec92dc7c2efa4fb3a70600584ab7106497   91842
    //00000000abbc297c10907d67786ecb6f48899d553fdb171228f82fa4dac98b0a  91880
    //nHeight==91842 && pindex->GetBlockHash() == uint256S("0x00000000000a4d0a398161ffc163c503763b1f4360639393e0e4c8e300e0caec"))
    //nHeight==91880 && pindex->GetBlockHash() == uint256S("0x00000000000743f190a18c5577a3c2d2a1f610ae9601ac046a38084ccb7cd721"))
...
bool checkBlockHeight(int blockHeight) {
    if (blockHeight > 212700) {
        return false;
    } else if (blockHeight >= 0 && blockHeight <= 212700) {
        return true;
    } else {
        return false;
    }
...
static bool ContextualCheckBlock(const CBlock& block, CValidationState& state, const Consensus::Params& consensusParams, const CBlockIndex* pindexPrev)
{
    ...
    if (nHeight >= consensusParams.BIP34Height)
    {
        ...
        //printf("Bip34-DEBUG:  vin[0].scriptSig.size:%d   expect.size:%d \n",block.vtx[0]->vin[0].scriptSig.size(), expect.size());
        std::string expect_str=HexStr(expect.begin(), expect.end());
        std::string scriptSig_str=HexStr(block.vtx[0]->vin[0].scriptSig.begin(),block.vtx[0]->vin[0].scriptSig.end());
        //printf("EXPECT - >X expect_str:%X\n",expect_str);
        //printf("ACTUALL - >X scriptSig_str:%X\n",scriptSig_str);
